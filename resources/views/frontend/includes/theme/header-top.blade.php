            ...
            <div class="col-lg-4">
                <ul class="header-top-list">
                    ...
                    <li class="dropdown-trigger language-dropdown"><a href=""><span class="flag-img"><img
                                    src="frontend/image/icon/eng-flag.png" alt=""></span>en-gb </a><i
                            class="fas fa-chevron-down dropdown-arrow"></i>
                        <ul class="dropdown-box">
                            <li> <a href=""> <span class="flag-img"><img src="frontend/image/icon/eng-flag.png"
                                            alt=""></span>English</a>
                            </li>
                            <li> <a href=""> <span class="flag-img"><img src="frontend/image/icon/germany-flag.png"
